...
- **Interactive Nodes**: Click on any node to navigate to that page
...
- **Color Coding**:
  - 🔵 Blue nodes represent documentation pages
  - 🟣 Purple nodes represent blog posts
  - 🟢 Green nodes represent standalone pages
- **Link Types**:
...
The network graph above is automatically generated during the build process by scanning all markdown files in your Docusaurus site. The visualization includes:

- **Docs**: All files in the `docs/` directory
- **Blog**: All files in the `blog/` directory
- **Pages**: All markdown files in the `src/pages/` directory
